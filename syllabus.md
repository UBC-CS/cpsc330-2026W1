...
See the [detailed grade policies](docs/grades.md) for more information.
...
See [homework submission instructions](docs/homework_instructions.md) for more detailed instructions on submitting homework assignments.
...
No action is required on your part to use the tokens, just make sure that you have a sufficient number if you are planning on using them.
...
See [exam accommodations](#exam-accommodations) for accommodation and booking guidance.
...
The official prerequisites can be found [in the course listing](https://courses.students.ubc.ca/cs/courseschedule?tname=subj-course&course=330&campuscd=UBC&dept=CPSC&pname=subjarea). If you do not meet the prerequisites, see [prerequisite guidance](https://www.cs.ubc.ca/students/undergrad/courses-deadlines/prerequisites) and [rules for prerequisite appeals](https://www.cs.ubc.ca/students/undergrad/courses-deadlines/rules-about-cpsc-appeals-undergraduate-students). We were told that students should not visit the front desk in the CS main office about prerequisite issues, because the folks at the front desk do not have the authority to resolve prerequisite issues.
